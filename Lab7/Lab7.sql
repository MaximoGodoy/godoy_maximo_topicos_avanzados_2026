--1)Crea un procedimiento aumentar_precio_producto que reciba un ProductoID
--y un porcentaje de aumento (como parámetros IN), y aumente el precio del 
--producto en ese porcentaje. Maneja la excepción si el producto no existe.
...
--2)Crea un procedimiento contar_pedidos_cliente que reciba un ClienteID
--(parámetro IN) y devuelva la cantidad de pedidos de ese cliente (parámetro OUT).
