--1) Crea un paquete gestion_clientes con:
...
-- 2) Modifica el paquete gestion_clientes para incluir una excepción personalizada 
-- e_edad_invalida que se lance si el cliente tiene menos de 18 años al registrarlo. Prueba el paquete con un cliente menor de edad.
